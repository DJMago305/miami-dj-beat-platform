...
(function () {
  ...
  /* PURGA-CATEGORIA-A (2026-09-16, orden del PO -- "alto a parches
     temporales"): mdjTabletHeaderScale (achicado de fuente/alto por JS en
     tablet) queda eliminada por completo. Sin reemplazo JS: el alto y la
     tipografía del header en todo ancho ≥601px corren 100% por CSS estático
     (header-unified.css, --mdj-header-unified-r1/r2). */
