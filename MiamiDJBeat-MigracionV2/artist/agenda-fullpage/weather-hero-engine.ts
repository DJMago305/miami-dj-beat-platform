// @ts-nocheck
// MOD-205 -- real WebGL Atmospheric Hero engine, ported verbatim from
// web/weather-experience/js/hero.js (shader + physics logic UNCHANGED --
// only DOM/lifecycle wiring adapted for direct SPA embedding, no iframe).
// This module is a faithful, byte-exact port of dense GLSL/animation code
// already validated visually in weather-experience/; hand-adding strict
// types here risks silently changing behavior for no safety benefit -- the
// correctness bar for this file is "renders exactly like the source",
// verified in-browser, not type coverage.
//
...
import { moonPhase as moonPhaseAt } from '../../shared/weather-3d/astro';
import { constellations, moonAltAz as moonAltAzRaw } from '../../shared/weather-3d/celestial';
...
export function initWeatherHeroEngine() {
  ...
  const PREVIEW = true;   // MOD-205 integration: controls stay live per PO instruction
